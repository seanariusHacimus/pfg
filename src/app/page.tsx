  ...
  return (
    <div>
      ...
      <section className="bg-gradient-to-b from-[#1a3b91] via-[#2E68FF] to-[#1a3b91]">
        ...
        <h1 className="text-7xl pt-56 leading-16">Ваш партнер<br /> в мире инвестиций<br /> и финансов</h1>
        <div className="flex py-14 items-center">
            <div className="flex gap-12 mr-20">
              <div className="flex flex-col pl-2.5 border-l border-[#2E68FF]">
                <span className="text-4xl leading-9">2000</span>
                <p className="text-2xl leading-6">успешных сделок</p>
              </div>
              <div className="flex flex-col pl-2.5 border-l border-[#2E68FF]">
                <span className="text-4xl leading-9">9 лет</span>
                <p className="text-2xl leading-6">в рынке финансов</p>
              </div>
              <div className="flex flex-col pl-2.5 border-l border-[#2E68FF]">
                <span className="text-4xl leading-9">250</span>
                <p className="text-2xl leading-6">клиентов</p>
              </div>
            </div>
            <p className="text-2xl leading-7">Услуги в области инвестиционного посредничества,<br /> выпуска ценных бумаг и сопровождения сделок.</p>
        </div>
        </div>
      </section>
      ...
      <section className=" bg-white text-black">
        <div className="container max-[1440px] m-auto py-14">
          <h2 className="text-4xl leading-9 pb-6 text-[#2450C4]">Наши услуги</h2>
      ...
      <section className=" bg-white text-black">
        <div className="container max-[1440px] m-auto py-14">
          <h2 className="text-4xl leading-9 pb-6 text-[#2450C4]">Быть удобным брокером для своего клиента</h2>
          <div className="flex gap-3">
      ...
      <section className=" bg-white text-black">
        <div className="container max-[1440px] m-auto py-14">
          <h2 className="text-4xl leading-9 pb-11 text-[#2450C4]">Почему мы?</h2>
      ...
      <section className="bg-white text-black bg-[url('/icons/bg.png')] bg-cover bg-center">
        <div className="container max-[1440px] m-auto py-14">
          <h2 className="text-4xl leading-9 pb-11 text-white">Наши сделки</h2>
      ...
      <section className=" bg-white text-black">
        <div className="container max-[1440px] m-auto py-14">
          <h2 className="text-4xl leading-9 pb-11 text-[#2450C4]">Наша команда</h2>
          <div className="flex gap-3">
      ...
      <section className="bg-white text-black">
        <div className="container max-[1440px] m-auto py-14">
          <h2 className="text-4xl leading-9 pb-11 text-[#2450C4]">Новости</h2>
          <div className="flex">
            <div className="w-1/2">
              <div className="flex items-center pb-11">
                ...
                <div>
                  ...
                  <h3 className="text-2xl leading-[26px] max-w-[360px]">Московская биржа возобновляет утреннюю сессию с 27 января 2025 года</h3>
                </div>
              </div>
              <div className="flex items-center pb-11">
                <Image className="mr-6" src="/icons/new-1.svg" alt="" width={227} height={150}/>
            ...
            <div className="w-1/2">
              <div>
                ...
                <h2 className="text-2xl leading-[26px]">Московская биржа возобновляет утреннюю сессию с 27 января 2025 года Московская биржа возобновляет утреннюю</h2>
              </div>
            </div>
          </div>
        </div>
